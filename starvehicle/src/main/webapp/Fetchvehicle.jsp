...
<%@ include file="Message.jsp" %>
    <h2>View Specific UnderWriter Vehicles</h2>
    <form action="Fetchvehicledetails" method="post">
        <label for="ID">Underwriter ID:</label>
        <input type="text" id="ID" name="ID" placeholder="Enter Underwriter ID" required>
